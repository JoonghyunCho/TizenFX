...
internal static partial class Interop
{
    internal static partial class ImageUtil
    {
        internal static partial class Transform
        {
            ...
            [LibraryImport(Libraries.ImageUtil, EntryPoint = "image_util_transform_create", StringMarshalling = StringMarshalling.Utf8)]
            internal static partial ImageUtilError Create(out TransformHandle handle);
