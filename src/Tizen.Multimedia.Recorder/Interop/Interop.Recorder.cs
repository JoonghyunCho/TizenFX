...
internal static partial class Interop
{
    ...
    {
        [LibraryImport(Libraries.Recorder, EntryPoint = "recorder_create_audiorecorder", StringMarshalling = StringMarshalling.Utf8)]
        internal static partial RecorderErrorCode Create(out RecorderHandle handle);

        [LibraryImport(Libraries.Recorder, EntryPoint = "recorder_create_videorecorder", StringMarshalling = StringMarshalling.Utf8)]
        internal static partial RecorderErrorCode CreateVideo(IntPtr cameraHandle, out RecorderHandle handle);
