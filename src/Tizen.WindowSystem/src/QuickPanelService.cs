...
namespace Tizen.WindowSystem.Shell
{
    ...
    public class QuickPanelService : IDisposable
    {
        ...
        private Tizen.WindowSystem.Shell.SafeHandles.QuickPanelServiceHandle _tzshQpService;
        ...
        public QuickPanelService(TizenShell tzShell, IWindowProvider win, QuickPanelType type)
        {
            if (tzShell == null)
            {
        ...
        /// <exception cref="ArgumentException">Thrown when failed of invalid argument.</exception>
        public QuickPanelType ServiceType
        {
            get
            {
                return GetType();
        ...
        private new QuickPanelType GetType()
        {
            int res;
            int type;
        ...
        /// <exception cref="ArgumentException">Thrown when failed of invalid argument.</exception>
        public void SetEffectType(QuickPanelEffectType type)
        {
            int res;

            res = Interop.QuickPanelService.SetEffectType(_tzshQpService, type);
            _tzsh.ThrowIfError(res);
        }
