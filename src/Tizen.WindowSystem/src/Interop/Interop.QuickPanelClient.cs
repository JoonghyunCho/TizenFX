...
namespace Tizen.WindowSystem.Shell
{
    internal static partial class Interop
    {
        internal static partial class QuickPanelClient
        {
            ...
            internal static extern SafeHandles.QuickPanelClientHandle CreateWithType(SafeHandles.TizenShellHandle tzsh, uint win, QuickPanelType type);
            ...
            internal static extern int SetScrollableState(SafeHandles.QuickPanelClientHandle qpClient, QuickPanelScrollableState scroll);
