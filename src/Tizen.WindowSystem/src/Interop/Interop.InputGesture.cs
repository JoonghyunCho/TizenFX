...
namespace Tizen.WindowSystem
{
    internal static partial class Interop
    {
        internal static class InputGesture
        {
            ...
            internal delegate void EdgeSwipeCb(IntPtr usergestureData, GestureMode mode, int fingers, int sx, int sy, GestureEdge edge);
            ...
            [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
            internal delegate void EdgeDragCb(IntPtr usergestureData, GestureMode mode, int fingers, int cx, int cy, GestureEdge edge);
            ...
            [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
            internal delegate void TapCb(IntPtr usergestureData, GestureMode mode, int fingers, int repeats);
            ...
            [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
            internal delegate void PalmCoverCb(IntPtr usergestureData, GestureMode mode, int duration, int cx, int cy, int size, double pressure);
