...
namespace Tizen.WindowSystem.Shell
{
    internal static partial class Interop
    {
        internal static partial class TizenRegion
        {
            ...
            internal static extern SafeHandles.TizenRegionHandle Create(SafeHandles.TizenShellHandle tzsh);
            ...
            internal static extern int Add(SafeHandles.TizenRegionHandle region, int x, int y, int w, int h);

            [global::System.Runtime.InteropServices.DllImport(lib, EntryPoint = "tzsh_region_subtract")]
            internal static extern int Subtract(SafeHandles.TizenRegionHandle region, int x, int y, int w, int h);
        }
    }
}
