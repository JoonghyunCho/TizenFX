...
namespace Tizen.WindowSystem.Shell
{
    internal static partial class Interop
    {
        internal static partial class SoftkeyClient
        {
            ...
            internal static extern int SetExpandState(SafeHandles.SoftkeyClientHandle softkeyClient, SoftkeyExpandState expand);
            ...
            internal static extern int SetOpacityState(SafeHandles.SoftkeyClientHandle softkeyClient, SoftkeyOpacityState opacity);
