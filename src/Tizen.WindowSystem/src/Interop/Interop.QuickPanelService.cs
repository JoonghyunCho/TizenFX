...
namespace Tizen.WindowSystem.Shell
{
    internal static partial class Interop
    {
        internal static partial class QuickPanelService
        {
            ...
            internal static extern SafeHandles.QuickPanelServiceHandle CreateWithType(SafeHandles.TizenShellHandle tzsh, uint win, QuickPanelType type);
            ...
            internal static extern int SetEffectType(SafeHandles.QuickPanelServiceHandle service, QuickPanelEffectType type);
