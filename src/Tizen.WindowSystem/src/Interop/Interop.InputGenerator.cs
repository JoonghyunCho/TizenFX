...
namespace Tizen.WindowSystem
{
    internal static partial class Interop
    {
        internal static partial class InputGenerator
        {
            ...
            internal static extern SafeHandles.InputGeneratorHandle Init(InputGeneratorDeviceType devType);

            [global::System.Runtime.InteropServices.DllImport(lib, EntryPoint = "efl_util_input_initialize_generator_with_name")]
            internal static extern SafeHandles.InputGeneratorHandle InitWithName(InputGeneratorDeviceType devType, string devName);

            [global::System.Runtime.InteropServices.DllImport(lib, EntryPoint = "efl_util_input_initialize_generator_with_sync")]
            internal static extern SafeHandles.InputGeneratorHandle SyncInit(InputGeneratorDeviceType devType, string devName);
            ...
            internal static extern ErrorCode GeneratePointer(SafeHandles.InputGeneratorHandle inputGenHandler, int buttons, InputGeneratorPointerType pointerType, int x, int y);

            [global::System.Runtime.InteropServices.DllImport(lib, EntryPoint = "efl_util_input_generate_wheel")]
            internal static extern ErrorCode GenerateWheel(SafeHandles.InputGeneratorHandle inputGenHandler, InputGeneratorPointerWheelType wheelType, int value);

            [global::System.Runtime.InteropServices.DllImport(lib, EntryPoint = "efl_util_input_generate_touch")]
            internal static extern ErrorCode GenerateTouch(SafeHandles.InputGeneratorHandle inputGenHandler, int idx, InputGeneratorTouchType touchType, int x, int y);

            [global::System.Runtime.InteropServices.DllImport(lib, EntryPoint = "efl_util_input_generate_touch_axis")]
            internal static extern ErrorCode GenerateTouchAxis(SafeHandles.InputGeneratorHandle inputGenHandler, int idx, InputGeneratorTouchType touchType, int x, int y, double radius_x, double radius_y, double pressure, double angle, double palm);
