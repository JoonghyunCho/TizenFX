...
namespace Tizen.WindowSystem.Shell
{
    ...
    public class QuickPanelClient : IDisposable
    {
        ...
        private SafeHandles.QuickPanelClientHandle _tzshQpClient;
        ...
        private event EventHandler<QuickPanelVisibleState> _visibleChanged;
        /// <summary>
        /// Emits the event when the visible state of the quickpanel service window is changed.
        /// </summary>
        /// <exception cref="ArgumentException">Thrown when failed of invalid argument.</exception>
        /// <since_tizen> 8 </since_tizen>
        public event EventHandler<QuickPanelVisibleState> VisibleChanged
        {
            add
            {
        ...
        /// <since_tizen> 12 </since_tizen>
        public QuickPanelClient(TizenShell tzShell, IWindowProvider win, QuickPanelType type)
        {
        ...
        private void OnVisibleChanged(int type, IntPtr ev_info, IntPtr data)
        {
            ...
            _visibleChanged?.Invoke(this, (QuickPanelVisibleState)state);
        }
        ...
        /// <since_tizen> 8 </since_tizen>
        public QuickPanelVisibleState Visible
        {
            get
            {
                return GetVisible();
        ...
        private QuickPanelVisibleState GetVisible()
        {
            int res;
            int vis;
            ...
            return (QuickPanelVisibleState)vis;
        }
        ...
        /// <exception cref="InvalidOperationException">Thrown when failed because of an invalid operation or no service.</exception>
        /// <since_tizen> 8 </since_tizen>
        public QuickPanelScrollableState Scrollable
        {
            get
            {
        ...
        private QuickPanelScrollableState GetScrollable()
        {
            int res;
            int scroll;
            ...
            return (QuickPanelScrollableState)scroll;
        }

        private void SetScrollable(QuickPanelScrollableState scroll)
        {
            int res;
