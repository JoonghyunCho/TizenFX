...
namespace Tizen.WindowSystem.Shell
{
    ...
    public class TaskbarService : IDisposable
    {
        ...
        private SafeHandles.TaskbarServiceHandle _taskbarService;
        ...
        public TaskbarService(TizenShell tzShell, IWindowProvider win, TaskbarPlaceType type = TaskbarPlaceType.Bottom)
        {
            if (tzShell == null)
            {
            ...
            Interop.TaskbarService.SetPlaceType(_taskbarService, type);
        }
        ...
        /// <exception cref="ArgumentException">Thrown when failed of invalid argument.</exception>
        public void SetPlaceType(TaskbarPlaceType type)
        {
            int res;

            res = Interop.TaskbarService.SetPlaceType(_taskbarService, type);
