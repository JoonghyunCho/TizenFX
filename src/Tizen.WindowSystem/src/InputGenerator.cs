...
namespace Tizen.WindowSystem
{
    ...
    public class InputGenerator : IDisposable
    {
        ...
        public InputGenerator(InputGeneratorDeviceType devType)
        {
            if (devType == InputGeneratorDeviceType.None)
            {
        ...
        public InputGenerator(InputGeneratorDeviceType devType, string name, bool sync = false)
        {
            if (devType == InputGeneratorDeviceType.None)
            {
                throw new ArgumentException("Invalid device type");
        ...
        public void GeneratePointer(int buttons, InputGeneratorPointerType pointerType, int x, int y)
        {
        ...
        public void GenerateWheel(InputGeneratorPointerWheelType wheelType, int value)
        {
        ...
        public void GenerateTouch(int idx, InputGeneratorTouchType touchType, int x, int y)
        {
        ...
        public void GenerateTouchAxis(int idx, InputGeneratorTouchType touchType, int x, int y, double radius_x, double radius_y, double pressure, double angle, double palm)
        {
            Interop.InputGenerator.ErrorCode res = Interop.InputGenerator.GenerateTouchAxis(_handler, idx, touchType, x, y, radius_x, radius_y, pressure, angle, palm);
            ThrowIfError(res);
        }
    }
}
