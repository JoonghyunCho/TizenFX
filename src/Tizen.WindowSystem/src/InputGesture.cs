    ...
    public class InputGesture : IDisposable
    {
        ...
        internal event EventHandler<EdgeSwipeEventArgs> EdgeSwipeEventHandler
        {
            add
            {
                ...
                {
                    _edgeSwipeDelegate = (IntPtr userData, GestureMode mode,  int fingers, int sx, int sy, GestureEdge edge) =>
                    {
        ...
        internal event EventHandler<EdgeDragEventArgs> EdgeDragEventHandler
        {
            add
            {
                ...
                {
                    _edgeDragDelegate = (IntPtr userData, GestureMode mode,  int fingers, int cx, int cy, GestureEdge edge) =>
                    {
        ...
        internal event EventHandler<TapEventArgs> TapEventHandler
        {
            add
            {
                ...
                {
                    _tapDelegate = (IntPtr userData, GestureMode mode,  int fingers, int repeats) =>
                    {
        ...
        internal event EventHandler<PalmCoverEventArgs> PalmCoverEventHandler
        {
            add
            {
                ...
                {
                    _palmCoverDelegate = (IntPtr userData, GestureMode mode,  int duration, int cx, int cy, int size, double pressure) =>
                    {
