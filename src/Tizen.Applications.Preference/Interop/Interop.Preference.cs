...
internal static partial class Interop
{
    ...
    internal static partial class Preference
    {
        ...
        internal delegate void ChangedCallback([MarshalAs(UnmanagedType.LPUTF8Str)] string key, IntPtr userData);

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate bool ItemCallback([MarshalAs(UnmanagedType.LPUTF8Str)] string key, IntPtr userData);
        ...
        internal static partial int SetBoolean(string key, [MarshalAs(UnmanagedType.I1)] bool value);

        [LibraryImport(Libraries.Preference, EntryPoint = "preference_get_boolean", StringMarshalling = StringMarshalling.Utf8)]
        internal static partial int GetBoolean(string key, [MarshalAs(UnmanagedType.I1)] out bool value);
        ...
        internal static partial int IsExisting(string key, [MarshalAs(UnmanagedType.I1)] out bool existing);
